  ...
  <body>
    <div class="navigation">
      ...
      <nav class="navigation__nav">
        <ul class="navigation__list">
          ...
          <li class="navigation__item">
            <a href="article.html" class="navigation__link"><span>04</span>Articles</a>
          </li>
          <li class="navigation__item">
            <a href="team.html" class="navigation__link"><span>05</span>Team</a>
          </li>
          <li class="navigation__item">
          ...
          <li class="navigation__item">
            <a href="#Contact" class="navigation__link"><span>06</span>Contact Us</a>
          </li>
        </ul>
      </nav>
    </div>
    ...
    <header class="header container-fluid">
      ...
      <div class="header__text-box">
        ...
        <!--  <span class="heading-primary--main display-1">Kaizen 6.0</span>   -->
          <span class="heading-primary--sub">Civil Engineering Society</span>
        </h1>

        <a href="article.html" class="btn btn--white btn--animated"
          >new ARTICLE !</a
        >
      </div>
    </header>
          ...
          <div class="row">
            <div class="col-12 col-sm-12 col-md-4">
              <div class="feature-box">
                ...
                <h3 class="heading-tertiary u-margin-bottom-small">Tirthraj Anand</h3>
                <p class="feature-box__text">Head</p>
                <p class="feature-box__text">(M) +91-6354185001</p>
                <p class="feature-box__text">ces.svnit2021@gmail.com</p>
              </div>
              <br /><br />
            </div>
            ...
            <div class="col-12 col-sm-12 col-md-4">
              <div class="feature-box">
                ...
                <h3 class="heading-tertiary u-margin-bottom-small">Yash Katiyar</h3>
                <p class="feature-box__text">Co-Head</p>
                <p class="feature-box__text">(M) +91-9887664462</p>
                <p class="feature-box__text">ces.svnit2021@gmail.com</p>
              </div>
              <br /><br />
            </div>
            ...
            <div class="col-12 col-sm-12 col-md-4">
              <div class="feature-box">
                ...
                <h3 class="heading-tertiary u-margin-bottom-small">Akshita Mittal</h3>
                <p class="feature-box__text">Co-Head</p>
                <p class="feature-box__text">(M) +91-9079052802</p>
                <p class="feature-box__text">ces.svnit2021@gmail.com</p>
              </div>
              <br /><br />
            </div>
